...
worker_processes  4;         // 设置为 auto 时，自动设置为 cpu 个数
worker_cpu_affinity 0001 0010 0100 1000;    // 给每个进程绑定一个 cpu，也可以设置为 auto
...
events {
    # 允许的连接数
    work_connections   2000;     # 允许连接的最大连接数,可以使用`ulimit -n`查看操作系统支持的最大连接数
